...
/**
 * Created by jagesh on 04/01/2016.
 * Discounted cumulative Gain (DCG) and Normalized Discounted cumulative Gain (NDCG@5) for Bing
 */
public class NDCG5Bing
{
    ...
    {
        NDCG5Bing ndcg5Bing = new NDCG5Bing();
        ndcg5Bing.readJsonfile();

        ndcg5Bing.thresholdMapping(judgeJ,judgeL,judgeO,judgeF);
    }
    ...
    public float[] DCG(int[] threshold)
    {
        ...
        for (int i = 0; i< threshold.length/4; i++)
        {
            if (i == 0)
    ...
    public void NDCG(float[] dcg,float[] idealdcg) throws IOException
    {
        ...
        evaluateAvgNDGC5(ndcg);
    }

    public void evaluateAvgNDGC5(float[] ndcg) throws IOException
    {
        float avgndcg=0;
        float sum=0;
